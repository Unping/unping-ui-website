      ...
      <section className="py-24 bg-neutral-950">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="text-display-lg font-bold text-white">Why Unping UI?</h2>
            <p className="text-neutral-400 mt-3">Desktop & Web first Flutter components. Customizable, extendable, tested.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            <Card className="relative bg-neutral-900/60 border-neutral-800/70">
              <GlowingEffect disabled={false} glow blur={12} borderWidth={2} spread={50} proximity={300} movementDuration={0.6} inactiveZone={0.2} />
              <CardHeader className="p-6">
                <CardTitle className="text-white">Ready for production</CardTitle>
                <CardDescription className="text-neutral-400">Accessible by default, consistent tokens, and patterns built for teams.</CardDescription>
              </CardHeader>
            </Card>
            <Card className="relative bg-neutral-900/60 border-neutral-800/70">
              <GlowingEffect disabled={false} glow blur={12} borderWidth={2} spread={50} proximity={300} movementDuration={0.6} inactiveZone={0.2} />
              <CardHeader className="p-6">
                <CardTitle className="text-white">Copy-and-own components</CardTitle>
                <CardDescription className="text-neutral-400">Use FPX to paste components into your codebase and customize freely.</CardDescription>
              </CardHeader>
            </Card>
            <Card className="relative bg-neutral-900/60 border-neutral-800/70">
              <GlowingEffect disabled={false} glow blur={12} borderWidth={2} spread={50} proximity={300} movementDuration={0.6} inactiveZone={0.2} />
              <CardHeader className="p-6">
                <CardTitle className="text-white">Widgetbook integration</CardTitle>
                <CardDescription className="text-neutral-400">Browse components and states at widgetbook.unping-ui.com.</CardDescription>
              </CardHeader>
            </Card>
            <Card className="relative bg-neutral-900/60 border-neutral-800/70">
              <GlowingEffect disabled={false} glow blur={12} borderWidth={2} spread={50} proximity={300} movementDuration={0.6} inactiveZone={0.2} />
              <CardHeader className="p-6">
                ...
                <CardDescription className="text-neutral-400">MIT licensed. Contribute on GitHub at github.com/unping/unping-ui.</CardDescription>
              </CardHeader>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="relative bg-neutral-900/60 border-neutral-800/70">
              <GlowingEffect disabled={false} glow blur={12} borderWidth={2} spread={50} proximity={300} movementDuration={0.6} inactiveZone={0.2} />
              <CardHeader className="p-8">
                <CardTitle className="text-white">Theming</CardTitle>
                <CardDescription className="text-neutral-400">Customize semantic tokens or create a new theme. Built for light & dark modes.</CardDescription>
              </CardHeader>
            </Card>
            <Card className="relative bg-neutral-900/60 border-neutral-800/70">
              <GlowingEffect disabled={false} glow blur={12} borderWidth={2} spread={50} proximity={300} movementDuration={0.6} inactiveZone={0.2} />
              <CardHeader className="p-8">
                ...
                <CardDescription className="text-neutral-400">Focus states, contrast-aware palettes, and keyboard-friendly patterns.</CardDescription>
              </CardHeader>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="relative bg-neutral-900/60 border-neutral-800/70">
              <GlowingEffect disabled={false} glow blur={12} borderWidth={2} spread={50} proximity={300} movementDuration={0.6} inactiveZone={0.2} />
              <CardHeader className="p-8">
                <CardTitle className="text-white">Versioning</CardTitle>
                <CardDescription className="text-neutral-400">We follow Semantic Versioning. See the CHANGELOG for the latest updates.</CardDescription>
              </CardHeader>
            </Card>
            <Card className="relative bg-neutral-900/60 border-neutral-800/70">
              <GlowingEffect disabled={false} glow blur={12} borderWidth={2} spread={50} proximity={300} movementDuration={0.6} inactiveZone={0.2} />
              <CardHeader className="p-8">
                ...
                <CardDescription className="text-neutral-400">Fully-typed code style, linted with very_good_analysis for consistency and quality.</CardDescription>
              </CardHeader>
            </Card>
          </div>
        </div>
